use arbitrage_core::{
    symbol_discovery::{
        MarketInfo, OrderBookDepth, SymbolDiscoveryService, SymbolSelectionCriteria,
    },
...
async fn test_enhanced_symbol_discovery() {
    ...
    discovery
        .update_market_data(market_info.clone())
        .await
        .unwrap();
...
async fn test_symbol_qualification_criteria() {
    ...
    discovery
        .update_market_data(low_volume_info.clone())
        .await
        .unwrap();
    ...
    discovery
        .update_market_data(low_volume_info2)
        .await
        .unwrap();
    ...
    discovery
        .update_market_data(high_spread_info.clone())
        .await
        .unwrap();
    ...
    discovery
        .update_market_data(high_spread_info2)
        .await
        .unwrap();
    ...
    discovery
        .update_market_data(good_info.clone())
        .await
        .unwrap();
